package com.iversonx.struts_springmvc.struts;
...
public class StrutsXmlConfigurationProvider extends XmlConfigurationProvider {
    ...
    /* (non-Javadoc)
     * @see XmlConfigurationProvider#register(com.opensymphony.xwork2.inject.ContainerBuilder, java.util.Properties)
     */
    @Override
